...
PATH=examples/bin/:../bin:./bin/:${PATH} turnutils_uclient -S -i /etc/ssh/id_rsa.cert -k /etc/ssh/id_rsa -R -E /etc/ssh/id_rsa.cert -n 1000 -m 10 -l 170 -e 127.0.0.1 -g -u ninefingers -w youhavetoberealistic -s $@ 127.0.0.1
