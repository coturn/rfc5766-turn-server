...
LIBTURN_HEADERS := src/turnserver/ns_turn_allocation.h src/turnserver/ns_turn_buffer.h src/turnserver/ns_turn_ioaddr.h src/turnserver/ns_turn_ioalib.h src/apps/common/ns_turn_defs.h src/turnserver/ns_turn_khash.h src/turnserver/ns_turn_maps_rtcp.h src/turnserver/ns_turn_maps.h src/turnserver/ns_turn_msg.h src/turnserver/ns_turn_msg_addr.h src/turnserver/ns_turn_msg.h src/turnserver/ns_turn_server.h src/turnserver/ns_turn_session.h src/turnserver/ns_turn_utils.h
LIBTURN_DEPS := ${LIBTURN_HEADERS} ${MAKE_DEPS} 
LIBTURN_OBJS := build/obj/ns_turn_allocation.o build/obj/ns_turn_buffer.o build/obj/ns_turn_ioaddr.o build/obj/ns_turn_maps_rtcp.o build/obj/ns_turn_maps.o build/obj/ns_turn_msg_addr.o build/obj/ns_turn_msg.o build/obj/ns_turn_server.o build/obj/ns_turn_utils.o

COMMON_DEPS := ${LIBTURN_DEPS} lib/libturn.a src/apps/common/ns_ioalib_impl.h src/apps/common/ns_ioalib_engine_impl.c src/apps/common/apputils.c src/apps/common/apputils.h src/apps/common/turn_ports.h src/apps/common/turn_ports.c
COMMON_MODS := src/apps/common/turnmutex.c src/apps/common/ns_ioalib_engine_impl.c src/apps/common/apputils.c src/apps/common/turn_ports.c
...
build/obj/ns_turn_buffer.o	:	src/turnserver/ns_turn_buffer.c ${LUBTURN_DEPS}
	mkdir -p build/obj
	${CC} ${CFLAGS} -c src/turnserver/ns_turn_buffer.c -o $@
